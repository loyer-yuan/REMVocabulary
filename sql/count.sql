...
CREATE TABLE `count`  (
  ...
  CONSTRAINT `count_ibfk_1` FOREIGN KEY (`username`) REFERENCES `user` (`username`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `pronounce`  (
  `words` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `pronounce` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
